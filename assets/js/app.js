const i18n = {
  "en": {
    ...
    "hero_title": "Testing Quantum Machine Learning (QML) Under Rigorous Financial Validation",
    ...
    "researcher_hero_role": "Research & Implementation",
    "researcher_footer_role": "Researcher & Project Author",
    "researcher_footer_desc": "Research · analysis · implementation · website",
    ...
    "deep_dive_preview": "<span>Inside</span> Model roles · Quantum Feature Map · Fidelity Kernel · Leakage controls · Diagnostics",
    ...
    "qfm_loop_badge": "Inside the Quantum Feature Map",
    "qfm_loop_title": "How one PCA-8 observation becomes an 8-qubit quantum state",
    "qfm_loop_caption": "This expands the feature-map block above: the PCA values control the RY rotations, while the same fixed CNOT chain is applied to every observation.",
    "qfm_loop_takeaway": "PCA values → set the RY angles → RY creates an amplitude pattern across 256 basis-state positions → the fixed CNOT chain structures the amplitude relationships in the joint 8-qubit state → |ψ(xᵢ)⟩",
    "qsvm_mechanism_kicker": "Mechanism",
    "qsvm_mechanism_title": "The complete QSVM kernel mechanism — 8 steps",
    "qsvm_mechanism_desc": "The sequence below shows the full path from the train-fitted input representation to the precomputed fidelity kernel used by the classical SVM.",
    "qsvm_evidence_kicker": "Interpretation boundary",
    "qsvm_evidence_title": "QSVM technical interpretation & evidence boundaries",
    "qsvm_evidence_desc": "These points clarify what the simulation supports, what it does not, and how the quantum-kernel diagnostics should be interpreted.",
  ...
  "th": {
    ...
    "hero_title": "ทดสอบ Quantum Machine Learning (QML) ด้วยการประเมินข้อมูลการเงินที่เข้มงวด",
    ...
    "researcher_hero_role": "วิจัยและพัฒนา",
    "researcher_footer_role": "ผู้วิจัยและผู้จัดทำโครงการ",
    "researcher_footer_desc": "งานวิจัย · การวิเคราะห์ · การพัฒนา · เว็บไซต์",
    ...
    "deep_dive_preview": "<span>ภายใน</span> บทบาทโมเดล · Quantum Feature Map · Fidelity Kernel · การควบคุม Leakage · Diagnostics",
    ...
    "qfm_loop_badge": "ภายใน Quantum Feature Map",
    "qfm_loop_title": "PCA-8 หนึ่ง observation ถูกแปลงเป็น 8-qubit quantum state อย่างไร",
    "qfm_loop_caption": "ส่วนนี้ขยายบล็อก Quantum Feature Map ด้านบน โดยค่า PCA เป็นตัวกำหนดมุม RY ขณะที่ fixed CNOT chain ใช้โครงสร้างเดิมกับทุก observation",
    "qfm_loop_takeaway": "PCA values → กำหนด RY angles → RY สร้างรูปแบบ amplitudes บน 256 basis-state positions → fixed CNOT chain จัดโครงสร้างความสัมพันธ์ของ amplitudes ใน joint 8-qubit state → ได้ |ψ(xᵢ)⟩",
    "qsvm_mechanism_kicker": "กลไกการทำงาน",
    "qsvm_mechanism_title": "กลไก QSVM kernel แบบครบถ้วน — 8 ขั้นตอน",
    "qsvm_mechanism_desc": "ลำดับด้านล่างแสดงเส้นทางทั้งหมดตั้งแต่ representation ที่ fit จาก training data ไปจนถึง precomputed fidelity kernel ที่ classical SVM นำไปใช้",
    "qsvm_evidence_kicker": "ขอบเขตการตีความ",
    "qsvm_evidence_title": "การตีความเชิงเทคนิคและขอบเขตหลักฐานของ QSVM",
    "qsvm_evidence_desc": "ประเด็นเหล่านี้ช่วยแยกว่า simulation นี้สนับสนุนข้อสรุปอะไร ไม่ได้สนับสนุนอะไร และควรอ่าน quantum-kernel diagnostics อย่างไร",
